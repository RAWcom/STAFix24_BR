    ...
    public class Klient
    {
        ...
        public Klient(Microsoft.SharePoint.SPWeb web, int klientId)
        {
            ...
            if (item != null)
            {
                ...
                FormaOpodatkowaniaPD = item["colFormaOpodatkowaniaPD"] != null ? item["colFormaOpodatkowaniaPD"].ToString() : string.Empty;
                ...
                switch (ct)
                {
                    ...
                    case "Firma wewnętrzna":
                        this.PelnaNazwaFirmy = BLL.Tools.Get_LookupValue(item, "selKlient");
                        break;
                    default:
